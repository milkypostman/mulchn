...
(function() {
  var answerTmpl, answerVotes, geoPosition, loginDialog, questionHtml, questionTmpl, questions, questionsHtml, selQuestion, toggleQuestion, updateQuestion, vote;
...
<li class="answer" id="{{ answer._id }}">\
  ...
  updateQuestion = function(data) {
    ...
    if (data.user_answer_id) {
      totalVotes = _.reduce(data.answers, function(t, a) {
      ...
      return $("#" + data.user_answer_id).addClass("vote");
    }
  };
